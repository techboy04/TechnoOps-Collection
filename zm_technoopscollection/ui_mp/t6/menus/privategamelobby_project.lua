...
CoD.PrivateGameLobby.PlayerSelect[16].id = "enable_mod_vox"
CoD.PrivateGameLobby.PlayerSelect[16].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[16].hintText = "Choose to toggle mod specific subtitles and/or audio. (Applies to Rampage, Exfil, and Intel related things)"
CoD.PrivateGameLobby.PlayerSelect[16].labels = {}
CoD.PrivateGameLobby.PlayerSelect[16].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[16].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.PlayerSelect[16].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[16].labels[4] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[16].values = {}
CoD.PrivateGameLobby.PlayerSelect[16].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[16].values[2] = 2
CoD.PrivateGameLobby.PlayerSelect[16].values[3] = 3
CoD.PrivateGameLobby.PlayerSelect[16].values[4] = 0
CoD.PrivateGameLobby.PlayerSelect[16].maps = {}
CoD.PrivateGameLobby.PlayerSelect[16].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[16].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[16].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[16].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[16].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[16].maps[6] = "zm_tomb"
