...
CoD.PrivateGameLobby.ModOptions[2].maps[2] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[2].gameTypes = {}
CoD.PrivateGameLobby.ModOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.ModOptions[2].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.ModOptions[3] = {}
CoD.PrivateGameLobby.ModOptions[3].id = "enable_exfil"
CoD.PrivateGameLobby.ModOptions[3].name = "EXFIL"
CoD.PrivateGameLobby.ModOptions[3].hintText = "Enabling Exfil will let you finish the match 'in style' every 5 rounds after round 10."
CoD.PrivateGameLobby.ModOptions[3].labels = {}
CoD.PrivateGameLobby.ModOptions[3].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[3].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[3].values = {}
CoD.PrivateGameLobby.ModOptions[3].values[1] = 1
CoD.PrivateGameLobby.ModOptions[3].values[2] = 0
CoD.PrivateGameLobby.ModOptions[3].maps = {}
CoD.PrivateGameLobby.ModOptions[3].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[3].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[3].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[3].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[3].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[3].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.ModOptions[3].gameTypes = {}
CoD.PrivateGameLobby.ModOptions[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.ModOptions[3].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.ModOptions[4] = {}
CoD.PrivateGameLobby.ModOptions[4].id = "enable_rampage"
CoD.PrivateGameLobby.ModOptions[4].name = "RAMPAGE STATUE"
CoD.PrivateGameLobby.ModOptions[4].hintText = "The Rampage Statue is similar to the Rampage Inducer from Cold War. Activation is one time."
...
CoD.PrivateGameLobby.ModOptions[5].id = "enable_usefulnuke"
CoD.PrivateGameLobby.ModOptions[5].name = "USEFUL NUKE"
CoD.PrivateGameLobby.ModOptions[5].hintText = "Grabbing a nuke will give you points for each zombie alive."
...
CoD.PrivateGameLobby.ModOptions[6].id = "enable_instantpap"
CoD.PrivateGameLobby.ModOptions[6].name = "INSTANT PAP"
CoD.PrivateGameLobby.ModOptions[6].hintText = "Remove the wait when using the Pack a Punch?"
...
CoD.PrivateGameLobby.ModOptions[7].id = "enable_compass"
CoD.PrivateGameLobby.ModOptions[7].name = "COMPASS"
CoD.PrivateGameLobby.ModOptions[7].hintText = "Display the Direction, Angle, and Zone you are at."
...
CoD.PrivateGameLobby.ModOptions[8].id = "enable_bo4ammo"
CoD.PrivateGameLobby.ModOptions[8].name = "FULL AMMO"
CoD.PrivateGameLobby.ModOptions[8].hintText = "Max Ammo will fill your magazine similar to Black Ops 4 and onwards."
...
CoD.PrivateGameLobby.ModOptions[9].id = "enable_vghudanim"
CoD.PrivateGameLobby.ModOptions[9].name = "VG PERK ANIM"
CoD.PrivateGameLobby.ModOptions[9].hintText = "Have an icon that appears in the middle of the screen whenever you grab a perk, similar to Vanguard."
...
CoD.PrivateGameLobby.ModOptions[10].id = "tranzit_alpha_round_end"
CoD.PrivateGameLobby.ModOptions[10].name = "ALPHA ROUND END"
CoD.PrivateGameLobby.ModOptions[10].hintText = "Whether or not to use Tranzits Round End sound from the Alpha."
...
CoD.PrivateGameLobby.ModOptions[11].id = "power_activates_buildables"
CoD.PrivateGameLobby.ModOptions[11].name = "POWERED BUILDABLES"
CoD.PrivateGameLobby.ModOptions[11].hintText = "When the power turns on, buildables that require a power source will turn on."
...
CoD.PrivateGameLobby.ModOptions[11].maps[2] = "zm_buried"
...
CoD.PrivateGameLobby.ModOptions[12].id = "enable_fog"
CoD.PrivateGameLobby.ModOptions[12].name = "FOG"
CoD.PrivateGameLobby.ModOptions[12].hintText = "Toggle whether or not you want fog."
CoD.PrivateGameLobby.ModOptions[12].labels = {}
CoD.PrivateGameLobby.ModOptions[12].labels[1] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[12].labels[2] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[12].values = {}
CoD.PrivateGameLobby.ModOptions[12].values[1] = 0
CoD.PrivateGameLobby.ModOptions[12].values[2] = 1
CoD.PrivateGameLobby.ModOptions[12].maps = {}
CoD.PrivateGameLobby.ModOptions[12].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[12].maps[2] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[12].maps[3] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[13].id = "enable_all_weapons"
CoD.PrivateGameLobby.ModOptions[13].name = "ALL ZOMBIE WEAPONS"
CoD.PrivateGameLobby.ModOptions[13].hintText = "Whether or not to add all zombies weapons to the map. (Excluding map specific wonder weapons)"
...
CoD.PrivateGameLobby.ModOptions[13].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[13].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[13].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[13].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[13].maps[6] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[14].id = "hit_sound"
CoD.PrivateGameLobby.ModOptions[14].name = "HITMARKER HIT SOUND"
CoD.PrivateGameLobby.ModOptions[14].hintText = "Sound that plays when you hit a zombie."
CoD.PrivateGameLobby.ModOptions[14].labels = {}
CoD.PrivateGameLobby.ModOptions[14].labels[1] = "NO SOUND"
CoD.PrivateGameLobby.ModOptions[14].labels[2] = "COLD WAR"
CoD.PrivateGameLobby.ModOptions[14].labels[3] = "MW 2019"
CoD.PrivateGameLobby.ModOptions[14].labels[4] = "BLACK OPS 4"
CoD.PrivateGameLobby.ModOptions[14].labels[5] = "OVERWATCH"
CoD.PrivateGameLobby.ModOptions[14].labels[6] = "APEX LEGENDS"
CoD.PrivateGameLobby.ModOptions[14].labels[7] = "8 BIT"
CoD.PrivateGameLobby.ModOptions[14].labels[8] = "MW CLASSIC"
...
CoD.PrivateGameLobby.ModOptions[14].values[3] = 2
CoD.PrivateGameLobby.ModOptions[14].values[4] = 3
CoD.PrivateGameLobby.ModOptions[14].values[5] = 4
CoD.PrivateGameLobby.ModOptions[14].values[6] = 5
CoD.PrivateGameLobby.ModOptions[14].values[7] = 6
CoD.PrivateGameLobby.ModOptions[14].values[8] = 7
CoD.PrivateGameLobby.ModOptions[14].maps = {}
CoD.PrivateGameLobby.ModOptions[14].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[14].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[14].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[14].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[14].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[14].maps[6] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[15].id = "kill_sound"
CoD.PrivateGameLobby.ModOptions[15].name = "HITMARKER KILL SOUND"
CoD.PrivateGameLobby.ModOptions[15].hintText = "Sound that plays when you kill a zombie."
CoD.PrivateGameLobby.ModOptions[15].labels = {}
CoD.PrivateGameLobby.ModOptions[15].labels[1] = "NO SOUND"
CoD.PrivateGameLobby.ModOptions[15].labels[2] = "COLD WAR"
CoD.PrivateGameLobby.ModOptions[15].labels[3] = "MW 2019"
CoD.PrivateGameLobby.ModOptions[15].labels[4] = "BLACK OPS 4"
CoD.PrivateGameLobby.ModOptions[15].labels[5] = "OVERWATCH"
CoD.PrivateGameLobby.ModOptions[15].labels[6] = "APEX LEGENDS"
CoD.PrivateGameLobby.ModOptions[15].labels[7] = "8 BIT"
CoD.PrivateGameLobby.ModOptions[15].labels[8] = "MW CLASSIC"
CoD.PrivateGameLobby.ModOptions[15].values = {}
CoD.PrivateGameLobby.ModOptions[15].values[1] = 0
CoD.PrivateGameLobby.ModOptions[15].values[2] = 1
CoD.PrivateGameLobby.ModOptions[15].values[3] = 2
CoD.PrivateGameLobby.ModOptions[15].values[4] = 3
CoD.PrivateGameLobby.ModOptions[15].values[5] = 4
CoD.PrivateGameLobby.ModOptions[15].values[6] = 5
CoD.PrivateGameLobby.ModOptions[15].values[7] = 6
CoD.PrivateGameLobby.ModOptions[15].values[8] = 7
...
CoD.PrivateGameLobby.ModOptions[16].id = "nuketown_perks_mode"
CoD.PrivateGameLobby.ModOptions[16].name = "PERKS MODE"
CoD.PrivateGameLobby.ModOptions[16].hintText = "How the perks should be handled."
CoD.PrivateGameLobby.ModOptions[16].labels = {}
CoD.PrivateGameLobby.ModOptions[16].labels[1] = "DEFAULT"
CoD.PrivateGameLobby.ModOptions[16].labels[2] = "ALL AT START"
CoD.PrivateGameLobby.ModOptions[16].labels[3] = "AFTER EVERY BELL CHIME"
CoD.PrivateGameLobby.ModOptions[16].labels[4] = "AFTER EVERY ROUND"
...
CoD.PrivateGameLobby.ModOptions[16].maps[1] = "zm_nuked"
...
CoD.PrivateGameLobby.ModOptions[17].id = "enable_recapturerounds"
CoD.PrivateGameLobby.ModOptions[17].name = "RECAPTURE ROUNDS"
CoD.PrivateGameLobby.ModOptions[17].hintText = "Whether or not you want to enable zombies recapturing generators."
CoD.PrivateGameLobby.ModOptions[17].labels = {}
CoD.PrivateGameLobby.ModOptions[17].labels[1] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[17].labels[2] = "ENABLED"
...
CoD.PrivateGameLobby.ModOptions[17].maps[1] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[18].id = "afterlife_doesnt_down"
CoD.PrivateGameLobby.ModOptions[18].name = "AFTERLIFE DOESNT DOWN"
CoD.PrivateGameLobby.ModOptions[18].hintText = "Whether or not Afterlife doesn't down the player when it expires."
CoD.PrivateGameLobby.ModOptions[18].labels = {}
CoD.PrivateGameLobby.ModOptions[18].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[18].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[18].values = {}
CoD.PrivateGameLobby.ModOptions[18].values[1] = 1
CoD.PrivateGameLobby.ModOptions[18].values[2] = 0
CoD.PrivateGameLobby.ModOptions[18].maps = {}
CoD.PrivateGameLobby.ModOptions[18].maps[1] = "zm_prison"
...
CoD.PrivateGameLobby.ModOptions[19].id = "planeparts_per_player"
CoD.PrivateGameLobby.ModOptions[19].name = "PLANE PARTS"
CoD.PrivateGameLobby.ModOptions[19].hintText = "How to handle the plane parts per player."
CoD.PrivateGameLobby.ModOptions[19].labels = {}
CoD.PrivateGameLobby.ModOptions[19].labels[1] = "NO PICKUP LIMIT"
CoD.PrivateGameLobby.ModOptions[19].labels[2] = "PER PLAYER"
...
CoD.PrivateGameLobby.ModOptions[19].maps[1] = "zm_prison"
...
CoD.PrivateGameLobby.ModOptions[20].id = "enable_mod_vox"
CoD.PrivateGameLobby.ModOptions[20].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.ModOptions[20].hintText = "Choose to toggle mod specific subtitles and/or audio. (Applies to Rampage, Exfil, and Intel related things)"
CoD.PrivateGameLobby.ModOptions[20].labels = {}
CoD.PrivateGameLobby.ModOptions[20].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.ModOptions[20].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.ModOptions[20].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.ModOptions[20].labels[4] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[20].values = {}
CoD.PrivateGameLobby.ModOptions[20].values[1] = 1
CoD.PrivateGameLobby.ModOptions[20].values[2] = 2
CoD.PrivateGameLobby.ModOptions[20].values[3] = 3
CoD.PrivateGameLobby.ModOptions[20].values[4] = 0
CoD.PrivateGameLobby.ModOptions[20].maps = {}
CoD.PrivateGameLobby.ModOptions[20].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[20].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[20].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[20].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[20].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[20].maps[6] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[21].id = "perk_limit"
CoD.PrivateGameLobby.ModOptions[21].name = "PERK LIMIT"
CoD.PrivateGameLobby.ModOptions[21].hintText = "Change the amount of perks players start out with."
CoD.PrivateGameLobby.ModOptions[21].labels = {}
CoD.PrivateGameLobby.ModOptions[21].labels[1] = "1"
CoD.PrivateGameLobby.ModOptions[21].labels[2] = "2"
CoD.PrivateGameLobby.ModOptions[21].labels[3] = "3"
CoD.PrivateGameLobby.ModOptions[21].labels[4] = "4"
CoD.PrivateGameLobby.ModOptions[21].labels[5] = "5"
CoD.PrivateGameLobby.ModOptions[21].labels[6] = "6"
CoD.PrivateGameLobby.ModOptions[21].labels[7] = "7"
CoD.PrivateGameLobby.ModOptions[21].labels[8] = "8"
CoD.PrivateGameLobby.ModOptions[21].labels[9] = "9"
CoD.PrivateGameLobby.ModOptions[21].values = {}
CoD.PrivateGameLobby.ModOptions[21].values[1] = 1
CoD.PrivateGameLobby.ModOptions[21].values[2] = 2
CoD.PrivateGameLobby.ModOptions[21].values[3] = 3
CoD.PrivateGameLobby.ModOptions[21].values[4] = 4
CoD.PrivateGameLobby.ModOptions[21].values[5] = 5
CoD.PrivateGameLobby.ModOptions[21].values[6] = 6
CoD.PrivateGameLobby.ModOptions[21].values[7] = 7
CoD.PrivateGameLobby.ModOptions[21].values[8] = 8
CoD.PrivateGameLobby.ModOptions[21].values[9] = 9
CoD.PrivateGameLobby.ModOptions[21].maps = {}
CoD.PrivateGameLobby.ModOptions[21].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[21].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[21].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[21].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[21].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[21].maps[6] = "zm_tomb"
