...
CoD.PrivateGameLobby.PlayerSelect[1].id = "GAMEMODE"
CoD.PrivateGameLobby.PlayerSelect[1].name = "GAMEMODE"
CoD.PrivateGameLobby.PlayerSelect[1].hintText = "Select a gamemode."
CoD.PrivateGameLobby.PlayerSelect[1].labels = {}
CoD.PrivateGameLobby.PlayerSelect[1].labels[1] = "CLASSIC"
CoD.PrivateGameLobby.PlayerSelect[1].labels[2] = "GUN GAME"
CoD.PrivateGameLobby.PlayerSelect[1].labels[3] = "CRANKED"
...
CoD.PrivateGameLobby.PlayerSelect[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[1].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[2] = {}
CoD.PrivateGameLobby.PlayerSelect[2].id = "enable_exfil"
CoD.PrivateGameLobby.PlayerSelect[2].name = "ENABLE EXFIL"
CoD.PrivateGameLobby.PlayerSelect[2].hintText = "Enabling Exfil will let you finish the match 'in style' every 5 rounds after round 10."
CoD.PrivateGameLobby.PlayerSelect[2].labels = {}
CoD.PrivateGameLobby.PlayerSelect[2].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[2].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[2].values = {}
CoD.PrivateGameLobby.PlayerSelect[2].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[2].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[2].maps = {}
CoD.PrivateGameLobby.PlayerSelect[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[2].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[2].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[3] = {}
CoD.PrivateGameLobby.PlayerSelect[3].id = "enable_rampage"
CoD.PrivateGameLobby.PlayerSelect[3].name = "RAMPAGE STATUE"
CoD.PrivateGameLobby.PlayerSelect[3].hintText = "The Rampage Statue is similar to the Rampage Inducer from Cold War. Activation is one time."
CoD.PrivateGameLobby.PlayerSelect[3].labels = {}
CoD.PrivateGameLobby.PlayerSelect[3].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[3].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[3].values = {}
CoD.PrivateGameLobby.PlayerSelect[3].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[3].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[3].maps = {}
CoD.PrivateGameLobby.PlayerSelect[3].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[3].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[3].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[3].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[3].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[3].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[3].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[3].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[4] = {}
CoD.PrivateGameLobby.PlayerSelect[4].id = "enable_usefulnuke"
CoD.PrivateGameLobby.PlayerSelect[4].name = "USEFUL NUKE"
CoD.PrivateGameLobby.PlayerSelect[4].hintText = "Grabbing a nuke will give you points for each zombie alive."
CoD.PrivateGameLobby.PlayerSelect[4].labels = {}
CoD.PrivateGameLobby.PlayerSelect[4].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[4].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[4].values = {}
CoD.PrivateGameLobby.PlayerSelect[4].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[4].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[4].maps = {}
CoD.PrivateGameLobby.PlayerSelect[4].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[4].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[4].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[4].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[4].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[4].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[4].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[4].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[4].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[5] = {}
CoD.PrivateGameLobby.PlayerSelect[5].id = "enable_instantpap"
CoD.PrivateGameLobby.PlayerSelect[5].name = "INSTANT PAP"
CoD.PrivateGameLobby.PlayerSelect[5].hintText = "Remove the wait when using the Pack a Punch?"
CoD.PrivateGameLobby.PlayerSelect[5].labels = {}
CoD.PrivateGameLobby.PlayerSelect[5].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[5].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[5].values = {}
CoD.PrivateGameLobby.PlayerSelect[5].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[5].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[5].maps = {}
CoD.PrivateGameLobby.PlayerSelect[5].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[5].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[5].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[5].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[5].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[5].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[5].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[5].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[5].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[6] = {}
CoD.PrivateGameLobby.PlayerSelect[6].id = "enable_compass"
CoD.PrivateGameLobby.PlayerSelect[6].name = "COMPASS"
CoD.PrivateGameLobby.PlayerSelect[6].hintText = "Display the Direction, Angle, and Zone you are at."
CoD.PrivateGameLobby.PlayerSelect[6].labels = {}
CoD.PrivateGameLobby.PlayerSelect[6].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[6].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[6].values = {}
CoD.PrivateGameLobby.PlayerSelect[6].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[6].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[6].maps = {}
CoD.PrivateGameLobby.PlayerSelect[6].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[6].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[6].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[6].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[6].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[6].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[6].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[6].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[6].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[7] = {}
CoD.PrivateGameLobby.PlayerSelect[7].id = "enable_bo4ammo"
CoD.PrivateGameLobby.PlayerSelect[7].name = "FULL AMMO"
CoD.PrivateGameLobby.PlayerSelect[7].hintText = "Max Ammo will fill your magazine similar to Black Ops 4 and onwards."
CoD.PrivateGameLobby.PlayerSelect[7].labels = {}
CoD.PrivateGameLobby.PlayerSelect[7].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[7].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[7].values = {}
CoD.PrivateGameLobby.PlayerSelect[7].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[7].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[7].maps = {}
CoD.PrivateGameLobby.PlayerSelect[7].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[7].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[7].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[7].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[7].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[7].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[7].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[7].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[7].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[8] = {}
CoD.PrivateGameLobby.PlayerSelect[8].id = "enable_vghudanim"
CoD.PrivateGameLobby.PlayerSelect[8].name = "VG PERK ANIM"
CoD.PrivateGameLobby.PlayerSelect[8].hintText = "Have an icon that appears in the middle of the screen whenever you grab a perk, similar to Vanguard."
CoD.PrivateGameLobby.PlayerSelect[8].labels = {}
CoD.PrivateGameLobby.PlayerSelect[8].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[8].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[8].values = {}
CoD.PrivateGameLobby.PlayerSelect[8].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[8].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[8].maps = {}
CoD.PrivateGameLobby.PlayerSelect[8].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[8].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[8].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[8].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[8].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[8].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[8].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[8].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[8].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[9] = {}
CoD.PrivateGameLobby.PlayerSelect[9].id = "power_activates_buildables"
CoD.PrivateGameLobby.PlayerSelect[9].name = "POWERED BUILDABLES"
CoD.PrivateGameLobby.PlayerSelect[9].hintText = "When the power turns on, buildables that require a power source will turn on."
CoD.PrivateGameLobby.PlayerSelect[9].labels = {}
CoD.PrivateGameLobby.PlayerSelect[9].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[9].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[9].values = {}
CoD.PrivateGameLobby.PlayerSelect[9].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[9].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[9].maps = {}
CoD.PrivateGameLobby.PlayerSelect[9].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[9].maps[2] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[9].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[9].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[9].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[10] = {}
CoD.PrivateGameLobby.PlayerSelect[10].id = "enable_fog"
CoD.PrivateGameLobby.PlayerSelect[10].name = "FOG"
CoD.PrivateGameLobby.PlayerSelect[10].hintText = "Toggle whether or not you want fog."
CoD.PrivateGameLobby.PlayerSelect[10].labels = {}
CoD.PrivateGameLobby.PlayerSelect[10].labels[1] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[10].labels[2] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[10].values = {}
CoD.PrivateGameLobby.PlayerSelect[10].values[1] = 0
CoD.PrivateGameLobby.PlayerSelect[10].values[2] = 1
CoD.PrivateGameLobby.PlayerSelect[10].maps = {}
CoD.PrivateGameLobby.PlayerSelect[10].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[10].maps[2] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[10].maps[3] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[10].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[10].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[10].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[11] = {}
CoD.PrivateGameLobby.PlayerSelect[11].id = "enable_all_weapons"
CoD.PrivateGameLobby.PlayerSelect[11].name = "ALL ZOMBIE WEAPONS"
CoD.PrivateGameLobby.PlayerSelect[11].hintText = "Whether or not to add all zombies weapons to the map. (Excluding map specific wonder weapons)"
CoD.PrivateGameLobby.PlayerSelect[11].labels = {}
CoD.PrivateGameLobby.PlayerSelect[11].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[11].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[11].values = {}
CoD.PrivateGameLobby.PlayerSelect[11].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[11].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[11].maps = {}
CoD.PrivateGameLobby.PlayerSelect[11].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[11].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[11].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[11].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[11].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[11].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[11].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[11].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[11].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[12] = {}
CoD.PrivateGameLobby.PlayerSelect[12].id = "enable_hitmarker"
CoD.PrivateGameLobby.PlayerSelect[12].name = "HITMARKER"
CoD.PrivateGameLobby.PlayerSelect[12].hintText = "Toggle the hitmarker whenever you hit or kill a zombie."
CoD.PrivateGameLobby.PlayerSelect[12].labels = {}
CoD.PrivateGameLobby.PlayerSelect[12].labels[1] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[12].labels[2] = "NO SOUND"
CoD.PrivateGameLobby.PlayerSelect[12].labels[3] = "COLD WAR"
CoD.PrivateGameLobby.PlayerSelect[12].labels[4] = "MW 2019"
CoD.PrivateGameLobby.PlayerSelect[12].labels[5] = "BLACK OPS 4"
CoD.PrivateGameLobby.PlayerSelect[12].labels[6] = "OVERWATCH"
CoD.PrivateGameLobby.PlayerSelect[12].labels[7] = "APEX LEGENDS"
CoD.PrivateGameLobby.PlayerSelect[12].labels[8] = "8 BIT"
CoD.PrivateGameLobby.PlayerSelect[12].values = {}
CoD.PrivateGameLobby.PlayerSelect[12].values[1] = 0
CoD.PrivateGameLobby.PlayerSelect[12].values[2] = 1
CoD.PrivateGameLobby.PlayerSelect[12].values[3] = 2
CoD.PrivateGameLobby.PlayerSelect[12].values[4] = 3
CoD.PrivateGameLobby.PlayerSelect[12].values[5] = 4
CoD.PrivateGameLobby.PlayerSelect[12].values[6] = 5
CoD.PrivateGameLobby.PlayerSelect[12].values[7] = 6
CoD.PrivateGameLobby.PlayerSelect[12].values[8] = 7
CoD.PrivateGameLobby.PlayerSelect[12].maps = {}
CoD.PrivateGameLobby.PlayerSelect[12].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[12].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[12].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[12].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[12].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[12].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[12].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[12].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[12].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[13] = {}
CoD.PrivateGameLobby.PlayerSelect[13].id = "nuketown_perks_mode"
CoD.PrivateGameLobby.PlayerSelect[13].name = "PERKS MODE"
CoD.PrivateGameLobby.PlayerSelect[13].hintText = "How the perks should be handled."
CoD.PrivateGameLobby.PlayerSelect[13].labels = {}
CoD.PrivateGameLobby.PlayerSelect[13].labels[1] = "DEFAULT"
CoD.PrivateGameLobby.PlayerSelect[13].labels[2] = "ALL AT START"
CoD.PrivateGameLobby.PlayerSelect[13].labels[3] = "AFTER EVERY BELL CHIME"
CoD.PrivateGameLobby.PlayerSelect[13].labels[4] = "AFTER EVERY ROUND"
CoD.PrivateGameLobby.PlayerSelect[13].values = {}
CoD.PrivateGameLobby.PlayerSelect[13].values[1] = 0
CoD.PrivateGameLobby.PlayerSelect[13].values[2] = 1
CoD.PrivateGameLobby.PlayerSelect[13].values[3] = 2
CoD.PrivateGameLobby.PlayerSelect[13].values[4] = 3
CoD.PrivateGameLobby.PlayerSelect[13].maps = {}
CoD.PrivateGameLobby.PlayerSelect[13].maps[1] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[13].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[13].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[13].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[14] = {}
CoD.PrivateGameLobby.PlayerSelect[14].id = "enable_recapturerounds"
CoD.PrivateGameLobby.PlayerSelect[14].name = "RECAPTURE ROUNDS"
CoD.PrivateGameLobby.PlayerSelect[14].hintText = "Whether or not you want to enable zombies recapturing generators."
CoD.PrivateGameLobby.PlayerSelect[14].labels = {}
CoD.PrivateGameLobby.PlayerSelect[14].labels[1] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[14].labels[2] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[14].values = {}
CoD.PrivateGameLobby.PlayerSelect[14].values[1] = 0
CoD.PrivateGameLobby.PlayerSelect[14].values[2] = 1
CoD.PrivateGameLobby.PlayerSelect[14].maps = {}
CoD.PrivateGameLobby.PlayerSelect[14].maps[1] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[14].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[14].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[14].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[15] = {}
CoD.PrivateGameLobby.PlayerSelect[15].id = "afterlife_doesnt_down"
CoD.PrivateGameLobby.PlayerSelect[15].name = "AFTERLIFE DOESNT DOWN"
CoD.PrivateGameLobby.PlayerSelect[15].hintText = "Whether or not Afterlife doesn't down the player when it expires."
CoD.PrivateGameLobby.PlayerSelect[15].labels = {}
CoD.PrivateGameLobby.PlayerSelect[15].labels[1] = "ENABLED"
CoD.PrivateGameLobby.PlayerSelect[15].labels[2] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[15].values = {}
CoD.PrivateGameLobby.PlayerSelect[15].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[15].values[2] = 0
CoD.PrivateGameLobby.PlayerSelect[15].maps = {}
CoD.PrivateGameLobby.PlayerSelect[15].maps[1] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[15].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[15].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[15].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[16] = {}
CoD.PrivateGameLobby.PlayerSelect[16].id = "planeparts_per_player"
CoD.PrivateGameLobby.PlayerSelect[16].name = "PLANE PARTS"
CoD.PrivateGameLobby.PlayerSelect[16].hintText = "How to handle the plane parts per player."
CoD.PrivateGameLobby.PlayerSelect[16].labels = {}
CoD.PrivateGameLobby.PlayerSelect[16].labels[1] = "NO PICKUP LIMIT"
CoD.PrivateGameLobby.PlayerSelect[16].labels[2] = "PER PLAYER"
CoD.PrivateGameLobby.PlayerSelect[16].values = {}
CoD.PrivateGameLobby.PlayerSelect[16].values[1] = 0
CoD.PrivateGameLobby.PlayerSelect[16].values[2] = 1
CoD.PrivateGameLobby.PlayerSelect[16].maps = {}
CoD.PrivateGameLobby.PlayerSelect[16].maps[1] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[16].gameTypes = {}
CoD.PrivateGameLobby.PlayerSelect[16].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.PlayerSelect[16].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.PlayerSelect[17] = {}
CoD.PrivateGameLobby.PlayerSelect[17].id = "enable_mod_vox"
CoD.PrivateGameLobby.PlayerSelect[17].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[17].hintText = "Choose to toggle mod specific subtitles and/or audio. (Applies to Rampage, Exfil, and Intel related things)"
CoD.PrivateGameLobby.PlayerSelect[17].labels = {}
CoD.PrivateGameLobby.PlayerSelect[17].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[17].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.PlayerSelect[17].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.PlayerSelect[17].labels[4] = "DISABLED"
CoD.PrivateGameLobby.PlayerSelect[17].values = {}
CoD.PrivateGameLobby.PlayerSelect[17].values[1] = 1
CoD.PrivateGameLobby.PlayerSelect[17].values[2] = 2
CoD.PrivateGameLobby.PlayerSelect[17].values[3] = 3
CoD.PrivateGameLobby.PlayerSelect[17].values[4] = 0
CoD.PrivateGameLobby.PlayerSelect[17].maps = {}
CoD.PrivateGameLobby.PlayerSelect[17].maps[1] = "zm_transit"
CoD.PrivateGameLobby.PlayerSelect[17].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.PlayerSelect[17].maps[3] = "zm_buried"
CoD.PrivateGameLobby.PlayerSelect[17].maps[4] = "zm_prison"
CoD.PrivateGameLobby.PlayerSelect[17].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.PlayerSelect[17].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.PlayerSelect[17].gameTypes = {}
