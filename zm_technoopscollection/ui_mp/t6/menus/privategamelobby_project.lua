...
CoD.PrivateGameLobby.ModOptions[2].id = "enable_exfil"
CoD.PrivateGameLobby.ModOptions[2].name = "ENABLE EXFIL"
CoD.PrivateGameLobby.ModOptions[2].hintText = "Enabling Exfil will let you finish the match 'in style' every 5 rounds after round 10."
CoD.PrivateGameLobby.ModOptions[2].labels = {}
CoD.PrivateGameLobby.ModOptions[2].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[2].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[2].values = {}
CoD.PrivateGameLobby.ModOptions[2].values[1] = 1
CoD.PrivateGameLobby.ModOptions[2].values[2] = 0
CoD.PrivateGameLobby.ModOptions[2].maps = {}
CoD.PrivateGameLobby.ModOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[2].maps[6] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[3].id = "enable_rampage"
CoD.PrivateGameLobby.ModOptions[3].name = "RAMPAGE STATUE"
CoD.PrivateGameLobby.ModOptions[3].hintText = "The Rampage Statue is similar to the Rampage Inducer from Cold War. Activation is one time."
...
CoD.PrivateGameLobby.ModOptions[4].id = "enable_usefulnuke"
CoD.PrivateGameLobby.ModOptions[4].name = "USEFUL NUKE"
CoD.PrivateGameLobby.ModOptions[4].hintText = "Grabbing a nuke will give you points for each zombie alive."
...
CoD.PrivateGameLobby.ModOptions[5].id = "enable_instantpap"
CoD.PrivateGameLobby.ModOptions[5].name = "INSTANT PAP"
CoD.PrivateGameLobby.ModOptions[5].hintText = "Remove the wait when using the Pack a Punch?"
...
CoD.PrivateGameLobby.ModOptions[6].id = "enable_compass"
CoD.PrivateGameLobby.ModOptions[6].name = "COMPASS"
CoD.PrivateGameLobby.ModOptions[6].hintText = "Display the Direction, Angle, and Zone you are at."
...
CoD.PrivateGameLobby.ModOptions[7].id = "enable_bo4ammo"
CoD.PrivateGameLobby.ModOptions[7].name = "FULL AMMO"
CoD.PrivateGameLobby.ModOptions[7].hintText = "Max Ammo will fill your magazine similar to Black Ops 4 and onwards."
...
CoD.PrivateGameLobby.ModOptions[8].id = "enable_vghudanim"
CoD.PrivateGameLobby.ModOptions[8].name = "VG PERK ANIM"
CoD.PrivateGameLobby.ModOptions[8].hintText = "Have an icon that appears in the middle of the screen whenever you grab a perk, similar to Vanguard."
...
CoD.PrivateGameLobby.ModOptions[9].id = "power_activates_buildables"
CoD.PrivateGameLobby.ModOptions[9].name = "POWERED BUILDABLES"
CoD.PrivateGameLobby.ModOptions[9].hintText = "When the power turns on, buildables that require a power source will turn on."
...
CoD.PrivateGameLobby.ModOptions[9].maps[2] = "zm_buried"
...
CoD.PrivateGameLobby.ModOptions[10].id = "enable_fog"
CoD.PrivateGameLobby.ModOptions[10].name = "FOG"
CoD.PrivateGameLobby.ModOptions[10].hintText = "Toggle whether or not you want fog."
CoD.PrivateGameLobby.ModOptions[10].labels = {}
CoD.PrivateGameLobby.ModOptions[10].labels[1] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[10].labels[2] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[10].values = {}
CoD.PrivateGameLobby.ModOptions[10].values[1] = 0
CoD.PrivateGameLobby.ModOptions[10].values[2] = 1
CoD.PrivateGameLobby.ModOptions[10].maps = {}
CoD.PrivateGameLobby.ModOptions[10].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[10].maps[2] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[10].maps[3] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[11].id = "enable_all_weapons"
CoD.PrivateGameLobby.ModOptions[11].name = "ALL ZOMBIE WEAPONS"
CoD.PrivateGameLobby.ModOptions[11].hintText = "Whether or not to add all zombies weapons to the map. (Excluding map specific wonder weapons)"
...
CoD.PrivateGameLobby.ModOptions[12].id = "hit_sound"
CoD.PrivateGameLobby.ModOptions[12].name = "HITMARKER HIT SOUND"
CoD.PrivateGameLobby.ModOptions[12].hintText = "Sound that plays when you hit a zombie."
CoD.PrivateGameLobby.ModOptions[12].labels = {}
CoD.PrivateGameLobby.ModOptions[12].labels[1] = "NO SOUND"
CoD.PrivateGameLobby.ModOptions[12].labels[2] = "COLD WAR"
CoD.PrivateGameLobby.ModOptions[12].labels[3] = "MW 2019"
CoD.PrivateGameLobby.ModOptions[12].labels[4] = "BLACK OPS 4"
CoD.PrivateGameLobby.ModOptions[12].labels[5] = "OVERWATCH"
CoD.PrivateGameLobby.ModOptions[12].labels[6] = "APEX LEGENDS"
CoD.PrivateGameLobby.ModOptions[12].labels[7] = "8 BIT"
...
CoD.PrivateGameLobby.ModOptions[12].values[3] = 2
CoD.PrivateGameLobby.ModOptions[12].values[4] = 3
CoD.PrivateGameLobby.ModOptions[12].values[5] = 4
CoD.PrivateGameLobby.ModOptions[12].values[6] = 5
CoD.PrivateGameLobby.ModOptions[12].values[7] = 6
CoD.PrivateGameLobby.ModOptions[12].maps = {}
CoD.PrivateGameLobby.ModOptions[12].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ModOptions[12].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ModOptions[12].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ModOptions[12].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ModOptions[12].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ModOptions[12].maps[6] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[13].id = "kill_sound"
CoD.PrivateGameLobby.ModOptions[13].name = "HITMARKER KILL SOUND"
CoD.PrivateGameLobby.ModOptions[13].hintText = "Sound that plays when you kill a zombie."
CoD.PrivateGameLobby.ModOptions[13].labels = {}
CoD.PrivateGameLobby.ModOptions[13].labels[1] = "NO SOUND"
CoD.PrivateGameLobby.ModOptions[13].labels[2] = "COLD WAR"
CoD.PrivateGameLobby.ModOptions[13].labels[3] = "MW 2019"
CoD.PrivateGameLobby.ModOptions[13].labels[4] = "BLACK OPS 4"
CoD.PrivateGameLobby.ModOptions[13].labels[5] = "OVERWATCH"
CoD.PrivateGameLobby.ModOptions[13].labels[6] = "APEX LEGENDS"
CoD.PrivateGameLobby.ModOptions[13].labels[7] = "8 BIT"
CoD.PrivateGameLobby.ModOptions[13].values = {}
CoD.PrivateGameLobby.ModOptions[13].values[1] = 0
CoD.PrivateGameLobby.ModOptions[13].values[2] = 1
CoD.PrivateGameLobby.ModOptions[13].values[3] = 2
CoD.PrivateGameLobby.ModOptions[13].values[4] = 3
CoD.PrivateGameLobby.ModOptions[13].values[5] = 4
CoD.PrivateGameLobby.ModOptions[13].values[6] = 5
CoD.PrivateGameLobby.ModOptions[13].values[7] = 6
...
CoD.PrivateGameLobby.ModOptions[14].id = "nuketown_perks_mode"
CoD.PrivateGameLobby.ModOptions[14].name = "PERKS MODE"
CoD.PrivateGameLobby.ModOptions[14].hintText = "How the perks should be handled."
CoD.PrivateGameLobby.ModOptions[14].labels = {}
CoD.PrivateGameLobby.ModOptions[14].labels[1] = "DEFAULT"
CoD.PrivateGameLobby.ModOptions[14].labels[2] = "ALL AT START"
CoD.PrivateGameLobby.ModOptions[14].labels[3] = "AFTER EVERY BELL CHIME"
CoD.PrivateGameLobby.ModOptions[14].labels[4] = "AFTER EVERY ROUND"
...
CoD.PrivateGameLobby.ModOptions[14].maps[1] = "zm_nuked"
...
CoD.PrivateGameLobby.ModOptions[15].id = "enable_recapturerounds"
CoD.PrivateGameLobby.ModOptions[15].name = "RECAPTURE ROUNDS"
CoD.PrivateGameLobby.ModOptions[15].hintText = "Whether or not you want to enable zombies recapturing generators."
CoD.PrivateGameLobby.ModOptions[15].labels = {}
CoD.PrivateGameLobby.ModOptions[15].labels[1] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[15].labels[2] = "ENABLED"
...
CoD.PrivateGameLobby.ModOptions[15].maps[1] = "zm_tomb"
...
CoD.PrivateGameLobby.ModOptions[16].id = "afterlife_doesnt_down"
CoD.PrivateGameLobby.ModOptions[16].name = "AFTERLIFE DOESNT DOWN"
CoD.PrivateGameLobby.ModOptions[16].hintText = "Whether or not Afterlife doesn't down the player when it expires."
CoD.PrivateGameLobby.ModOptions[16].labels = {}
CoD.PrivateGameLobby.ModOptions[16].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ModOptions[16].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[16].values = {}
CoD.PrivateGameLobby.ModOptions[16].values[1] = 1
CoD.PrivateGameLobby.ModOptions[16].values[2] = 0
CoD.PrivateGameLobby.ModOptions[16].maps = {}
CoD.PrivateGameLobby.ModOptions[16].maps[1] = "zm_prison"
...
CoD.PrivateGameLobby.ModOptions[17].id = "planeparts_per_player"
CoD.PrivateGameLobby.ModOptions[17].name = "PLANE PARTS"
CoD.PrivateGameLobby.ModOptions[17].hintText = "How to handle the plane parts per player."
CoD.PrivateGameLobby.ModOptions[17].labels = {}
CoD.PrivateGameLobby.ModOptions[17].labels[1] = "NO PICKUP LIMIT"
CoD.PrivateGameLobby.ModOptions[17].labels[2] = "PER PLAYER"
...
CoD.PrivateGameLobby.ModOptions[17].maps[1] = "zm_prison"
...
CoD.PrivateGameLobby.ModOptions[18].id = "enable_mod_vox"
CoD.PrivateGameLobby.ModOptions[18].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.ModOptions[18].hintText = "Choose to toggle mod specific subtitles and/or audio. (Applies to Rampage, Exfil, and Intel related things)"
CoD.PrivateGameLobby.ModOptions[18].labels = {}
CoD.PrivateGameLobby.ModOptions[18].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.ModOptions[18].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.ModOptions[18].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.ModOptions[18].labels[4] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[18].values = {}
CoD.PrivateGameLobby.ModOptions[18].values[1] = 1
CoD.PrivateGameLobby.ModOptions[18].values[2] = 2
CoD.PrivateGameLobby.ModOptions[18].values[3] = 3
CoD.PrivateGameLobby.ModOptions[18].values[4] = 0
...
CoD.PrivateGameLobby.ModOptions[19].id = "guided_mode"
CoD.PrivateGameLobby.ModOptions[19].name = "GUIDED MODE"
CoD.PrivateGameLobby.ModOptions[19].hintText = "When enabled, have objective markers guide you through the Main Quest. Difficulty will be reduced. (Mod Quests only)"
CoD.PrivateGameLobby.ModOptions[19].labels = {}
CoD.PrivateGameLobby.ModOptions[19].labels[1] = "DISABLED"
CoD.PrivateGameLobby.ModOptions[19].labels[2] = "ENABLED"
