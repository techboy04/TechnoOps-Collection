...
LUI.createMenu.PowerUpsArea = function (LocalClientIndex)
	...
	for ClientFieldIndex = 1, #CoD.PowerUps.ClientFieldNames, 1 do
		if CoD.PowerUps.ClientFieldNames[ClientFieldIndex].clientFieldName == "powerup_fire_sale" and UIExpression.DvarInt(nil, "gamemode") == 2 then
		
		elseif CoD.PowerUps.ClientFieldNames[ClientFieldIndex].clientFieldName == "powerup_fire_sale" and UIExpression.DvarInt(nil, "gamemode") == 6 then
