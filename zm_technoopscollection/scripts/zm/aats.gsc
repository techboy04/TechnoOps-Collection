...
main()
{	
	if(getDvarInt("experimental_aats") != 1)
	{
		return;
	}
	...
	replacefunc(maps\mp\zombies\_zm_perks::third_person_weapon_upgrade, ::third_person_weapon_upgrade_new);
}
...
third_person_weapon_upgrade_new( current_weapon, upgrade_weapon, packa_rollers, perk_machine, trigger )
{
